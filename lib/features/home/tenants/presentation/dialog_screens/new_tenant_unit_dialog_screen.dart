...
class NewTenatUnitDialogScreen extends StatefulWidget {
  const NewTenatUnitDialogScreen({super.key});

  @override
  State<NewTenatUnitDialogScreen> createState() => _NewTenatUnitDialogScreen();
}

class _NewTenatUnitDialogScreen extends State<NewTenatUnitDialogScreen> {
